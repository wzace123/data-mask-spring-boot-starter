...
public class DataMaskUtilTest {
    ...
    public void init() {
        ...
        serviceMap.put("_" + MaskedType.USER_NAME.name(), new UserNameMaskHandler());
        serviceMap.put("_" + MaskedType.ID_CARD.name(), new IdCardNumMaskHandler());
        serviceMap.put("_" + MaskedType.MOBILE_PHONE.name(), new MobilePhoneMaskHandler());
        serviceMap.put("_" + MaskedType.ADDRESS.name(), new AddressMaskHandler());
        serviceMap.put("_" + MaskedType.PASSWORD.name(), new PasswordMaskHandler());
        serviceMap.put("_" + MaskedType.IPV4.name(), new Ipv4MaskHandler());
        serviceMap.put("_" + MaskedType.IPV6.name(), new Ipv6MaskHandler());
        serviceMap.put("_" + MaskedType.CAR_LICENSE.name(), new CarLicenseMaskHandler());
        serviceMap.put("_" + MaskedType.BANK_CARD.name(), new BankCardMaskHandler());
        serviceMap.put("_" + MaskedType.FIXED_PHONE.name(), new FixedPhoneMaskHandler());
        serviceMap.put("_" + MaskedType.EMAIL.name(), new EmailMaskHandler());
